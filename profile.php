  ...
  switch ($_GET['view']) {
    ...
    case 'events':
	  ...
	  case 'about':        
		...
		/* get pages */
		$profile['abouts'] = $user->get_pages( array('user_id' => $profile['user_id']) );
		/* get custom fields */
		$smarty->assign('custom_fields', $user->get_custom_fields( array("for" => "user", "get" => "profile", "node_id" => $profile['user_id']) ));             
		break;            
	...
	case 'place':    
		...
		/* get pages */
		$profile['all_about'] = $user->get_pages( array('user_id' => $profile['user_id']) );
		/* get custom fields */
		$smarty->assign('custom_fields', $user->get_custom_fields( array("for" => "user", "get" => "profile", "node_id" => $profile['user_id']) ));          
		break;   
	...
	case 'work':  
		...
		/* get pages */
		$profile['workandschool'] = $user->get_pages( array('user_id' => $profile['user_id']) );
