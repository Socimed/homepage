...
try {
  ...
  if ($system['monetization_enabled'] && $user->_data['user_group'] == 3 && !$spage['i_admin']) {
    /* page */
    if ($spage['page_monetization_enabled']) {
  ...
  switch ($_GET['view']) {
    case '':
      ...
      /* get subscribers */
      if ($system['monetization_enabled'] && $spage['page_monetization_enabled']) {
