...
switch ($_GET['do']) {
  case 'in':
    ...
    // page header
    page_header(__($system['system_title']) . " &rsaquo; " . __("Masuk"));
  ...
  case 'up':
    ...
    // page header
    page_header(__($system['system_title']) . " &rsaquo; " . __("Daftar"));
  ...
  case 'reset':
    ...
    // page header
    page_header(__($system['system_title']) . " &rsaquo; " . __("Lupa Password anda?"));
