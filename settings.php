...
try {
  ...
  switch ($_GET['view']) {
    ...
    case 'profile':
      ...
      switch ($_GET['sub_view']) {
        ...
        case 'privacy-information':
             page_header(__("Kelola")." &rsaquo; ".__("Privasi Informasi BuddyTag"));            
    ...
    case 'delete':
      ...
      case 'admin-messages':                                 
        // page header
        page_header(__("Admin")." &rsaquo; ".__("Messages"));            
        // get widgets
        $widgets = $user->widgets('home');
        /* assign variables */
        $smarty->assign('widgets', $widgets);
      ...
      case 'languages':
        // page header
        page_header(__("Settings")." &rsaquo; ".__("Languages"));            
...
case '':
  // page header
  page_header(__("Dashboard")." &rsaquo; ".__("Other menu "));
  ...
  break;
            ...
            case 'themes':
                // page header
                page_header(__("Dashboard")." &rsaquo; ".__("Themes"));            
...
// page header
page_header(__("Dashboard")." &rsaquo; ".__("My Dashboard")); 
break;            

case 'analytics-dashboard':

// page header
page_header(__("Dashboard")." &rsaquo; ".__("Analytics"));            
    // get announcements
...
case 'static-dashboard':
    ...
    $smarty->assign('widgets', $widgets);            
// page header
page_header(__("Dashboard")." &rsaquo; ".__("Settings"));
/* get followers count */
$profile['followers_count'] = count($user->get_followers_ids($profile['user_id']));      
    
/* get followers count */
$profile['followings_count'] = count($user->get_followers_ids($profile['user_id']));    
...
case '':
  // page header
  page_header(__("Statistic")." &rsaquo; ".__("Dashboard"));
  ...
  break;
      ...
      // page header
      page_header($system['system_title'].' - '.__("Wallet Payments"));
