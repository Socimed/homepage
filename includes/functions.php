    ...
    switch ($args[0]) {
      case 'DB_ERROR':
        ...
        $message = "<div class='text-left'><h1>" . "Error establishing a database connection" . "</h1>
                            ...
                            <p>" . "If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the" . " <a href='https://buddyengine.blogspot.com'>" . "Buddy Engine Support" . ".</a></p>
                            </div>";
        break;
 ...
 * @return string
 */
function paypal($handle, $price, $id = null, $node_type = null)
{
  global $system;
  /* prepare */
  switch ($handle) {
    ...
    case 'subscribe':
      ...
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/paypal.php?status=success&handle=subscribe&node_id=$id&node_type=$node_type";
      $URL['cancel'] = $system['system_url'] . "/paypal.php?status=cancel";
      break;
 ...
 * @return string
 */
function stripe($method, $handle, $price, $id = null, $node_type = null)
{
  global $system;
  /* prepare */
  switch ($handle) {
    case 'packages':
      $product = __($system['system_title']) . " " . __('Pro Package');
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/stripe.php?status=success&handle=packages&package_id=$id";
      $URL['cancel'] = $system['system_url'] . "/stripe.php?status=cancel";
      break;

    case 'wallet':
      $product = __($system['system_title']) . " " . __('Wallet');
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/stripe.php?status=success&handle=wallet";
      $URL['cancel'] = $system['system_url'] . "/stripe.php?status=cancel";
      $_SESSION['wallet_replenish_amount'] = $price;
      break;
    ...
    case 'donate':
      $product = __($system['system_title']) . " " . __('Funding Donation');
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/stripe.php?status=success&handle=donate&post_id=$id";
      $URL['cancel'] = $system['system_url'] . "/stripe.php?status=cancel";
      $_SESSION['donation_amount'] = $price;
      break;
    ...
    case 'subscribe':
      $product = __($system['system_title']) . " " . __('Subscribe');
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/stripe.php?status=success&handle=subscribe&node_id=$id&node_type=$node_type";
      $URL['cancel'] = $system['system_url'] . "/stripe.php?status=cancel";
      break;
 ...
 * @return string
 */
function paystack($handle, $price, $id = null, $node_type = null)
{
  global $system, $user;
  /* prepare */
  switch ($handle) {
    ...
    case 'subscribe':
      $callback = $system['system_url'] . "/paystack.php?status=success&handle=subscribe&node_id=$id&node_type=$node_type";
      break;
 ...
 * @return string
 */
function cashfree($handle, $price, $id, $billing_name, $billing_email, $billing_phone, $node_type = null)
{
  global $system;
  /* prepare */
  ...
  switch ($handle) {
    ...
    case 'subscribe':
      $return_url .= "&handle=subscribe&node_id=$id&node_type=$node_type";
      break;
 ...
 * @return array
 */
function coinbase($handle, $price, $id = null, $node_type = null)
{
  global $system;
  /* prepare */
  ...
  switch ($handle) {
    ...
    case 'subscribe':
      $product = __($system['system_title']) . " " . __('Subscribe');
      $description = __('Pay For') . " " . __($system['system_title']);
      $URL['success'] = $system['system_url'] . "/coinbase.php?status=success&handle=subscribe&node_id=$id&node_type=$node_type&coinbase_hash=$coinbase_hash";
      $URL['cancel'] = $system['system_url'] . "/coinbase.php?status=cancel";
      break;
