...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "subscribe", $price, $_POST['node_id'], $_POST['node_type']);
      break;
