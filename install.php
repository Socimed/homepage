<?php
set_time_limit(0); 
define('SYS_VER', 'Pre-Release');
define('SYS_NAME', 'Buddy Engine');
...
if (isset($_POST['submit'])) {
  if ($requirements_errors) {
    _error("Error", "Anda perlu memeriksa persyaratan sistem untuk melanjutkan, Kembali ke dukungan hosting Anda untuk mendapatkan bantuan.");
}
  ...
  if (!valid_email($_POST['admin_email'])) {
    _error("Error", "silakan isi alamat email");
  }
  if (!valid_username($_POST['admin_username'])) {
    _error("Error", "Masukkan nama pengguna yang valid (a-z0-9_.) dengan panjang minimal 3 karakter");
  }
  ...
  if (is_empty($_POST['admin_password']) || strlen($_POST['admin_password']) < 6) {
    _error("Error", "Panjang kata sandi Anda harus minimal 6 karakter. Silakan coba yang lain");
  }
$structure = "
...
(1, 'about', 'About', 'Buddy Engine adalah Social Media yang dibuat dengan dasar ingin mencoba membuat Komunitas-komunitas yang berbeda dengan yang lain', '1', 1),
(2, 'terms', 'Terms', 'Persyaratan Buddy Engine', '1', 2),
(3, 'privacy', 'Privacy', 'Privacy Tentang Buddy Engine', '1', 3);
...
(1, 'Indonesian Rupiah', 'IDR', 'Rp', 'left', '0', '1'),
(2, 'United States Dollar', 'USD', '$', 'left', '1', '1');
...
(1, 'id_id', 'Indonesia', 'flags/fr_fr.png', 'LTR', '1', '1', 2);
...
(4, 'system_title', 'Buddy Engine'),
(5, 'system_description', 'Buat lah Komunitas Baru dengan hanya di Buddy Engine, ajak teman-temanmu untuk bergabung'),
(6, 'system_keywords', ''),
(7, 'system_email', ''),
...
(117, 'uploads_prefix', 'buddyengine'),
...
(125, 'video_Extensis', 'mp4, webm, ogg, mov, m4a, 3gp, 3g2, mj2, asf, avi, flv, webm, m4v, mpeg, ogv, mkv'),
(126, 'audio_enabled', '1'),
(127, 'max_audio_size', '5120'),
(128, 'audio_Extensis', 'mp3, wav, ogg'),
(129, 'file_enabled', '1'),
(130, 'max_file_size', '5120'),
(131, 'file_Extensis', 'txt, zip, json, docx'),
(132, 's3_enabled', '0'),
(133, 's3_bucket', ''),
...
(147, 'ftp_path', './'),
(148, 'ftp_endpoint', ''),
(149, 'session_hash', '7cbNrGEZq-21mX7-3k1B7-3bIl8-4AK1K-80e43af61055'),
...
(181, 'bank_name', 'BCA - Bank Central Asia'),
(182, 'bank_account_number', ''),
(183, 'bank_account_name', 'Buddy Engine'),
(184, 'bank_account_routing', ''),
(185, 'bank_account_country', ''),
(186, 'bank_transfer_note', 'Untuk mengonfirmasi transfer bank, Anda perlu mengunggah tanda terima atau mengambil tangkapan layar transfer Anda dalam 1 hari sejak tanggal pembayaran. Jika transfer bank dilakukan tetapi tidak ada tanda terima yang diunggah dalam periode ini, pesanan Anda akan dibatalkan. Kami akan memverifikasi dan mengonfirmasi tanda terima Anda dalam waktu 3 hari kerja sejak tanggal Anda mengunggahnya.'),
...
(198, 'system_logo', ''),
(199, 'system_wallpaper_default', '0'),
(200, 'system_wallpaper', '/content/themes/BuddyEngine/images/be-dark.jpg'),
...
(211, 'css_btn_primary', ''),
(212, 'css_custome_css', '/* \r\n\r\nAnda dapat menambahkan kode CSS Anda di sini \r\nContoh:\r\np { text-align: center; color: red; }\r\n\r\n*/'),
(213, 'custome_js_header', '/* \r\nAnda dapat menambahkan kode JavaScript Anda di sini\r\n\r\nContoh:\r\n\r\nvar x, y, z;\r\nx = 1;\r\ny = 2;\r\nz = x + y;\r\n*/'),
...
(220, 'affiliate_payment_method', 'bank'),
...
(228, 'points_payment_method', 'bank'),
...
(306, 'system_description_directory', 'Buddy Engine Adalah Tempatnya menemukan Komunitas Baru dan bertemu orang baru, buat koneksi baru, dan dapatkan teman baru'),
(307, 'system_description_offers', 'Temukan penawaran baru'),
(308, 'system_description_jobs', 'Temukan tawaran pekerjaan baru'),
(309, 'system_description_blogs', 'Jelajahi artikel terbaru'),
(310, 'system_description_marketplace', 'Temukan produk baru'),
(311, 'system_description_forums', 'Tempat yang bagus untuk mendiskusikan topik dengan pengguna lain'),
(312, 'system_description_movies', 'Temukan film baru'),
(313, 'stories_duration', '3'),
(314, 'desktop_infinite_scroll', '1'),
(315, 'disable_declined_friendrequest', '0'),
(316, 'wallet_withdrawal_enabled', '1'),
(317, 'wallet_payment_method', 'bank'),
...
(336, 'system_description_funding', 'Temukan permintaan pendanaan baru'),
...
(1610, 'monetization_payment_method', 'bank'),
...
(1623, 'activity_posts_permission', 'everyone'),
...
(1, 'like', 'Suka', '#1E8BD2', 'reactions/like.png'),
(2, 'love', 'Love', '#F25268', 'reactions/love.png'),
(3, 'haha', 'Haha', '#F3B715', 'reactions/haha.png'),
(4, 'yay', 'Senang', '#F3B715', 'reactions/yay.png'),
(5, 'wow', 'Wow', '#F3B715', 'reactions/wow.png'),
(6, 'sad', 'Sedih', '#F3B715', 'reactions/sad.png'),
(7, 'angry', 'Marah', '#F7806C', 'reactions/angry.png');
...
CREATE TABLE `users` (
  ...
  `user_language` varchar(16) DEFAULT 'id_id',
...
--
ALTER TABLE `system_options`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2054;
    ...
    <div class="container">
      <form id="wizard" method="post" class="position-relative">
                   ...
                   <h3 class="card-three">
                        <div class="media">
                            <div class="media-body">
                                <div class="bd-wizard-step-title">Buddy Engine!</div>
                                <div class="bd-wizard-step-subtitle">Langkah ke 1</div>
                            </div>
                        </div>
                    </h3>
                    <section>
                        <div class="content-wrapper">
                            <center>        <img src="includes/assets/js/core/installer/favicon.png" /></center>
                            <h3 class="section-heading">Selamat datang di Buddy Engine!</h3>
                            <p>
                                Selamat Datang di <strong><?php echo SYS_NAME ?></strong> proses instalasi! Isi apa saja yang diperlukan untuk
                                komunitas online Anda sendiri. <strong><i>CATATAN: Installer ini Diwajibkan Konek ke Internet, Mohon Periksa Jaringan anda</i></strong>
                            </p>
                            <h6 class="mt-4">
                                <strong>LICENSE AGREEMENT:</strong>
                            </h6>
                            <div style="margin-left:20px;background:#ccc;padding:10px;height:200px;display:block;width:100%;overflow:auto;">
                                <div>
                                    <strong>Anda Dapat melakukan :</strong>
                                    <ol>
                                        <li>Instal pada satu (1) produk akhir (Contoh : <b>domain.com</b>, <b>sub.domain.com</b>, atau <b>domain.com/directory</b>).</li>
                                        <li>Instal di server <b>localhost</b> Anda untuk pengujian atau pengembangan <b><?php echo SYS_NAME ?></b>.</li>
                                        <li>Edit kode sumber dan desain sesuai keinginan Anda untuk memenuhi Komunitas yang anda buat.</li>
                                    </ol>
                                </div>
                                <div>
                                    <strong>Anda Tidak Dapat Melakukan:</strong>
                                    <ol>
                                        <li>Jalankan di Nomor (2) atau lebih produk akhir secara bersamaan dengan lisensi yang sama.</li>
                                        <li>Menjual kembali, mendistribusikan, memberikan, atau memperdagangkan dengan cara apa pun kepada pihak ketiga atau individu manapun.</li>
                                    </ol>
                                </div>
                            </div>
                            <div class="form-check mt-5">
                                <input type="checkbox" class="form-check-input" id="license-checkbox">
                                <label class="form-check-label" for="license-checkbox">Saya setuju dengan Persyaratan dan
                                Kondisi ini.</label>
                                <div class="invalid-feedback">
                                    Anda harus setuju terlebih dahulu untuk melanjutkan.
                                </div>
                            </div>
                        </div>
                    </section>
        ...
        <h3>
          <div class="media">
            <div class="media-body">
              <div class="bd-wizard-step-title">Persyaratan</div>
              <div class="bd-wizard-step-subtitle">Langkah ke 2</div>
            </div>
          </div>
        </h3>
        <section>
          <div class="content-wrapper">
            ...
            <strong>Maaf!</strong> Anda perlu memeriksa persyaratan sistem untuk melanjutkan, Kembali ke
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  <td>PHP 5.5+</td>
                  <td>Dibutuhkan <b>PHP versi ke 5.5</b> atau lebih</td>
                  <td>
                    <?php if ($requirements_errors['PHP']) { ?>
                      <font color="red"><i class="fas fa-times-circle"></i> Tidak Terinstall</font>
                    <?php } else { ?>
                      <font color="green"><i class="fas fa-check-circle"></i> Terinstall</font>
                    <?php } ?>
                  </td>
                </tr>
                <tr>
                  <td>MySQLi</td>
                  <td>Dibutuhkan <b>MySQLi PHP</b> Extensi</td>
                  <td>
                ...
                <tr>
                  <td>cURL</td>
                  <td>Dibutuhkan cURL PHP Extensi</td>
                  <td>
                ...
                <tr>
                  <td>Mbstring</td>
                  <td>Dibutuhkan <b>Mbstring</b> Extensi untuk String UTF-8 </td>
                  <td>
                ...
                <tr>
                  <td>GD Library</td>
                  <td>Dibutuhkan <b>GD Library</b> untuk menangani gambar</td>
                  <td>
                ...
                <tr>
                  <td>ZIP</td>
                  <td>Dibutuhkan ZIP Extensi for taking backup</td>
                  <td>
                ...
                <tr>
                  ...
                  <td>Dibutuhkan <b>allow_url_fopen</b></td>
                  <td>
                ...
                <tr>
                  <td>.htaccess</td>
                  <td>Dibutuhkan .htaccess file untuk link <small><strong>(Located in ./Script)</strong></small>
                  </td>
                  <td>
                ...
                <tr>
                  <td>config.php</td>
                  <td>Dibutuhkan <strong>includes</strong> folder agar dapat ditulisi untuk instalasi</td>
                  <td>
        ...
        <h3>
          <div class="media">
            <div class="media-body">
              ...
              <div class="bd-wizard-step-subtitle">Langkah ke 3</div>
            </div>
          </div>
        </h3>
        <section>
          <div class="content-wrapper">
            <div class="row extended">
              <div class="form-group col-12">
                <input type="text" name="purchase_code" id="purchase_code" class="form-control" placeholder="xxx-xx-xxxx" value="buddyEngineV1.0">
                <div class="invalid-feedback">
                  Kolom Tidak Boleh Kosong
                </div>
              </div>
            </div>
            <h4 class="section-heading mt-4">Database Untuk Install Website</h4>
            <div class="row">
              <div class="form-group col-12">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label for="db_host">Database Host Contoh (localhost)</label>
            ...
            <h4 class="section-heading mt-4">Detail Tentang Admin</h4>
            <div class="row">
              <div class="form-group col-12">
        ...
        <h3>
          <div class="media">
            <div class="media-body">
              <div class="bd-wizard-step-title">Finishing</div>
              <div class="bd-wizard-step-subtitle">Langkah ke 4</div>
            </div>
          </div>
        </h3>
        <section>
          <div class="content-wrapper">
            <h4 class="section-heading mb-5">Review Kembali Data Anda</h4>
        ...
        <div id="loader" style="display: none;">
          ...
          <center>        <img src="includes/assets/js/core/installer/favicon.png" /></center> Sedang Menginstall <span class="spinner-grow spinner-grow-sm ml-3"></span>
          </div>
        </div>
        <!-- Loader -->
      </form>
